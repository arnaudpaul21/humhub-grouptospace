...
if ($canInviteExternal && $model->hasErrors('inviteExternal')) {
    ...
    $isInviteGroupTabActiveClass = '';
    $isInviteTabActiveClass = '';
}
else if ($canInviteGroups && $model->hasErrors('inviteGroups')) {
    $isInviteGroupTabActiveClass = 'active';
    $isInviteTabActiveClass = '';
...
<?php $form = ActiveForm::begin(['id' => 'space-invite-modal-form', 'action' => $submitAction]) ?>
    <div class="modal-body">
        <?php if ($canInviteExternal) : ?>
            <div class="text-center">
                <ul id="tabs" class="nav nav-tabs tabs-center" data-tabs="tabs">
                    ...
                    <?php if ($canInviteGroups) : ?>
                    <li class=" tab-internal">
                        <a href="#groups" data-toggle="tab"><?= Yii::t('GrouptospaceModule.base', 'Pick group'); ?></a>
                    </li>
                    <?php endif; ?>
        ...
        <div class="tab-content">
            ...
            <?php if ($canInviteGroups) : ?>
            <div class="<?= $isInviteExternalTabActiveClass ?> tab-pane"  id="groups">

                <?= $form->field($model, 'inviteGroups')->dropDownList($groups); ?>
